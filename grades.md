...
Junior - это следующий шаг на дорожной карте разработчика. Разработчик становится полноценным членом нашей команды, который отныне имеет чёткие полномочия и обязанности.
...
### Обязанности
- Уметь анализировать и уточнять требования к задаче
...
# Middle
Middle это серьёзный промежуточный шаг на дорожной карте разработчика. Middle разработчик - самостоятельная единица команды с четкими зонами ответственности и полномочий.
...
# Seniors
Senior - это ступень, подразумевающая очень высокий уровень технической экспертизы и ответственности.
...
- Умение выстроить архитектуру нового проекта
